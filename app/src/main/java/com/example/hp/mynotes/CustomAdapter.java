...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder> implements View.OnClickListener,FullScreenDialogFragment.OnConfirmListener,
    ...
    public CustomAdapter(Context mContext,ArrayList<String> titlesList,ArrayList<String> contentsList,ArrayList<String> datesList,ArrayList<Integer> isImportant,NotesFragment fragment) {
        ...
        holder.parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new FullScreenDialogFragment.Builder(mContext).setTitle(""+titlesList.get(position))
                        ...
                        .setOnConfirmListener(CustomAdapter.this)
                        .setOnDiscardListener(CustomAdapter.this)
